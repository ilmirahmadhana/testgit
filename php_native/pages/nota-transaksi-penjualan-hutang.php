                  ...
                  <tbody>
                    ...
                    <tr>
                        <th style="font-weight:normal;"><a style="font-weight:bold;">Nama : </a><?php echo $data['nm_customer'];?></th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th style="font-weight:normal;"><a style="font-weight:bold;">Kurang : </a>Rp.<?php echo number_format($data['jml_hutang']);?></th>
                    </tr>
                    <tr>
                        <th style="font-weight:normal;"><a style="font-weight:bold;">Jatuh tempo : </a><?php echo $data['tgl_jthtempo'];?></th>
                    </tr>
                    <tr>
                ...
                function cetak() {
                    ...
                    myWindow.document.write("<h2 style='margin-bottom:-2px;'>TOKO CAT STASIUN WARNA</h2><hr>Jl. Mawar, Tegal Rejo, Jemberlor, Patrang, Jember <br>Regency, Jawa Timur 68118<br><hr><a style='font-weight:bold;'>Kode&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<a><?php echo $data['id_pj'];?><br><a style='font-weight:bold;'>Tanggal&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<a><?php echo date("d-m-Y", strtotime($data['tgl']));?><br><a style='font-weight:bold;'>Nama&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<a><?php echo $data['nm_customer'];?><br><a style='font-weight:bold;'>Total&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<a>Rp.<?php echo number_format($data['total_harga']);?><br><a style='font-weight:bold;'>Bayar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<a>Rp.<?php echo number_format($data['bayar']);?><br><a style='font-weight:bold;'>Kurang&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<a>Rp.<?php echo number_format($data['jml_hutang']);?><br><a style='font-weight:bold;'>Jatuh tempo&nbsp;&nbsp;:&nbsp;<a><?php echo $data['tgl_jthtempo'];?><hr><a style='font-weight:bold;'>Barang yang telah dibayar, tidak dapat dikembalikan</a>");
