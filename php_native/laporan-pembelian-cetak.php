...
?>
        <title>Cetak Laporan Penjualan</title>
          <!-- DataTables Example -->
              ...
              <h1 style="text-align:center; font-family:'Times New Roman';">LAPORAN PEMBELIAN</h1>
                <form method="post">
                  ...
                  <tbody>
                      <?php
                        ...
                        if(isset($_POST['pilih'])){
                            $bulan = $_POST['bulan'];
                            $query = mysqli_query($koneksi,"SELECT * FROM transaksi_pb WHERE tgl like '%$bulan%' AND bayar > total_harga");
                        }else{
                    ...
                    <tr>
                      ...
                      <td style="text-align:center;"><?php echo $data['id_pb'];?></td>
